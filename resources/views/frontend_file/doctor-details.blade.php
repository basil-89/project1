...
<body>
    ...
    <section class="wcu-section-two">
        <div class="container-fluid">
                            ...
                            <div class="card-body">
                                <div class="main-outer-card">
                                    <div class="doctor-photo doctor-details-card-profile">
                                         <div class="image-inner-div"><img src="{{asset('/assets/img/doctors/'.$doctor_info->image)}}" alt="Image"></div>
                                    </div>
                                    <div class="doctor-information doctor-detail-card-information">
                                <h5 class="name">
                                    <a href="#"></a>
                                </h5>
                                @if($doctor_info->department == 0)

                                    <span class="specialty">uncategorized</span>

                                
                                @else

                                    <span class="specialty">{{$category->category_name}}</span>

                                
                                @endif
                                <p>{{$doctor_info->experience}} years experience overall</p>
                                ...
                                <p>{{$doctor_info->detail}}<a href="#">More</a></p>
                                <div class="row">
            ...
            $avg_stars = Illuminate\Support\Facades\DB::table('doctor_rating')->where('doctor_id',$doctor_info->id)
                ->avg('rating');
                $avg_rate = Illuminate\Support\Facades\DB::table('doctor_rating')->where('doctor_id',$doctor_info->id)
                ->get();

                $avg_review = Illuminate\Support\Facades\DB::table('doctor_rating')->where('doctor_id',$doctor_info->id)
                ->count();
                        @endphp
                        <div class="card doctor-card">
                            <div class="card-body">
                                                                ...
                                                                <h4 class="avg-rating-container"> 
                                                                    ...
                                                                    <span class="avg-rating"> 
                                                                       ...
                                                                       <p>
                                                                        ...
                                                                        @endif
                                                                    @endfor
                                                                <span>({{$avg_review}} Reviews)</span></p>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                                @foreach($avg_rate as $rate)
                                <div class="main-outer-cards main-card-border">
                                    <div class="doctor-photo doctor-review-card-profile">
                                         <div class="image-inner-div"><img src="{{asset('assets/avatar-659651__340.webp')}}" alt="Image"></div>
                                    </div>
                    ...
                    <div class="col-lg-4 col-md-4 my-right-card">
                        <div class="my-widget widget-user-about">
                            ...
                            <div class="user-info">
                                ...
                                <ul class="info-list">
                                    <li><span>Joined:</span>{{$doctor_info->joined}}</li>
                                    <li><span>E-mail:</span>{{$doctor_info->email}}</li>
                                    <li><span>Address:</span>{{$doctor_info->address}}</li>
                                    <li><span>Phone:</span>+{{$doctor_info->phone}}</li>
                                    @if($doctor_info->country == 0)
                                    <li><span>Country:</span>No Country</li>
                                    @else
                                    <li><span>Country:</span>{{$country->country}}</li>
                                    @endif
                                    <li><span>Web:</span><a href="#">{{$doctor_info->web}}</a></li>
                        ...
                        <div class="my-widget widget-user-about">
                            ...
                            <div class="user-info">
                                ...
                                @foreach($services as $service)
                                    ...
                                    <li><span>{{$service->service_name}}</li>
                                    @endforeach
                          ...
                          <div class="my-widget widget-user-about">
                            ...
                            <div class="user-info">
                                <p>Hi! My name is Rebeca Powel but some people may know me asserty GamePagla! I have a Newbike channel where I stream.</p>
                                <ul class="info-list">
                                    <li><span>Specializations:</span><p>{{$doctor_info->specializations}}</p></li>
                                    <li><span>Education:</span><p>{{$doctor_info->education}}</p></li>
                                    <li><span>Memberships:</span><p>{{$doctor_info->memberships}}</p></li>
                                    <li><span>Registrations:</span><p>{{$doctor_info->registrations}}</p></li>
                                </ul>
                            </div>
                        </div>
                                          ...
                                          <div class="modal-body doctor-review-model">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-12 question-dev">
                                                    <h5>{{$rev->review_q}} <span>(Select all that apply)</span></h5>
                                                </div>
                                                @php
                                                $opt = json_decode($rev->option_1);
