    ...
    <header class="template-header sticky-header header-one">
                ...
                <div class="header-left">
                    ...
                    <nav class="site-menu menu-gap-left d-none d-xl-block">
                        <ul class="primary-menu">
                            ...
                            <li> <a href="Hospital.html">Hospital</a>
                                <ul class="sub-menu">
        ...
        <div class="slide-panel mobile-slide-panel">
            ...
            <div class="panel-inner">
                <div class="panel-logo"> <img src="assets/img/logo.png" alt=""> </div>
        ...
        <div class="col-md-6 mx-auto">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h2 class="title login-title text-center mb-4 mt-1">Signup as Doctor</h2>
                </div>
            </div>
            <div class="card box-shadow-vendor p-3">
                <div class="card-body">
                    <div class="become-form">
                        <form class="gmz-form-action" action="https://holidays4men.com/become-a-partner" method="POST">
                            ...
                            <div class="row">
                                <div class="form-group col-lg-6">
                                    ...
                                    <input type="text" name="first_name" class="form-control gmz-validation is-invalid" data-validation="required" id="first-name">
                                </div>
                                <div class="form-group col-lg-6">
                                ...
                                <div class="form-group col-lg-12">
                                    <label for="last-name">Clinic Name</label>
                                    <input type="text" name="last_name" class="form-control" id="last-name">
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="form-group col-lg-6">
                                <label for="email">Work Number<span class="required">*</span> </label>
                                <input type="text" name="email" class="form-control gmz-validation" data-validation="required" id="email">
                            </div>
                            <div class="form-group col-lg-6">
                                <label for="email">Personal Number<span class="required">*</span> </label>
                                <input type="text" name="email" class="form-control gmz-validation" data-validation="required" id="email">
                            </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="address" rows="8" class="form-control " id="address"></textarea>
                            </div>
                            <div class="form-group">
                                <label class="checkbox-inline">
                                    <input type="checkbox" name="agree" value="1">
                                    I accept <a href="https://holidays4men.com/page/privacy-policies" class="link">Terms and Conditions</a>
                                </label>
                            </div>
                            <div class="gmz-message"></div>
                            <button type="submit" class="btn btn-primary pt-2 pl-3 pr-3 pb-2">SUBMIT REQUEST</button>
                        </form>
                    </div>
                </div>
            </div>
