...
<body>
    ...
    <!--====== End Template Header ======-->
        ...
        <!--====== Page Title Start ======-->
    <section class="page-title-area page-title-bg search-banner" style="background-image: url(assets/img/section-bg/page-title.jpg);">
    ...
    <section class="doctors-section section-gap">
        <div class="container">
            <div class="row doctors-loop">
                <div class="col-lg-12 col-md-12 col-12 feature-title mb-5">
                    <h3 class="title">713 doctors available in Bangalore</h3>
                    <p class="u-x-large-font">Book appointments with minimum wait-time &amp; verified doctor details</p>
                </div>
