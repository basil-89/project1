                        ...
                        <div class="become-form">
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-6 col-12 mb-2">
                                        <div class="facebook-btn">
                                            <a href="{{url('login/facebook')}}"><span class="fab fa-facebook"></span> &nbsp;Facebook</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                              ...
                              <strong>{{ $message }}</strong>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-12 text-center">Don't have an account? <a href="/register">Register Now</a></div>
                                </div>
                            </form>
                        </div>
                    </div>
