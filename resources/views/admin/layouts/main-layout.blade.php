...
<head>
  ...
  <link href="{{ asset('admin/assets/css/my-custom-style.css') }}" rel="stylesheet" />
  <link href="{{ asset('admin/assets/css/pages/wizard/wizard-3.css?v=7.0.6') }}" rel="stylesheet" />
  <link href="https://cdn.jsdelivr.net/npm/summernote@0.8.18/dist/summernote.min.css" rel="stylesheet">
  <link href="{{ asset('admin/assets/plugins/custom/datatables/datatables.bundle.css?v=7.0.6') }}" rel="stylesheet" />
  <link href="{{ asset('admin/assets/plugins/custom/leaflet/leaflet.bundle.css?v=7.0.6') }}" rel="stylesheet" />
...
<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <script>
        ...
        <script src="{{asset('admin/assets/plugins/custom/ckeditor/ckeditor-classic.bundle.js?v=7.0.6')}}"></script>
        <script src="{{asset('admin/assets/js/pages/crud/forms/editors/ckeditor-classic.js?v=7.0.6')}}"></script>
        <script src="{{asset('admin/assets/js/pages/custom/wizard/wizard-3.js?v=7.0.6')}}"></script>
        <script src="{{asset('admin/assets/js/pages/crud/file-upload/image-input.js?v=7.0.6')}}"></script>
        <script src="{{asset('admin/assets/js/pages/crud/file-upload/dropzonejs.js?v=7.0.6')}}"></script>
        <script src="{{asset('admin/assets/plugins/custom/leaflet/leaflet.bundle.js?v=7.0.6')}}"></script>
        <script src="{{asset('admin/assets/js/pages/features/maps/leaflet.js?v=7.0.6')}}"></script>
        <script src="{{asset('admin/assets/js/pages/crud/forms/widgets/select2.js?v=7.0.6')}}"></script>
        <script type="text/javascript" src="{{asset('admin/assets/js/pages/crud/forms/editors/quill.js?v=7.0.6 ')}}"></script>
        <!--end::Page Scripts-->
