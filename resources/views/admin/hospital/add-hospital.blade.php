...
@endif
                        ...
                        <div class="row justify-content-center py-10 px-8 py-lg-12 px-lg-10">
                            <div class="col-xl-12 col-xxl-7">
                                <!--begin: Wizard Form-->
                                <form class="form" id="kt_form" method="post" action="{{url('admin/add/hospital')}}" enctype="multipart/form-data">
                                   @csrf
                                    <!--begin: Wizard Step 1-->
                                    <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-6">
		                                        ...
		                                        <div class="form-group">
		                                            <label>Name</label>
		                                            <input type="text" value="" class="form-control" required name="hospital_name" />
		                                        </div>
		                                        <!--end::Input-->
                                            </div>
                                            <div class="col-xl-6">
		                                        ...
		                                        <div class="form-group">
		                                            ...
		                                            <input type="email" class="form-control" required value="" name="hospital_email" />
		                                        </div>
		                                        <!--end::Input-->
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-xl-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="tel" class="form-control" value="" name="hospital_phone" />
                                            ...
                                            <div class="col-xl-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="tel" class="form-control" value="" required name="hospital_mobile" />
                                                </div>
                                                <!--end::Input-->
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-xl-6">
                                                ...
                                                <div class="form-group">
                                                    <label>Website</label>
                                <input type="text" class="form-control" value="" name="hospital_web" />
                                                </div>
                                                <!--end::Input-->
                                            </div>
                                        </div>
                          ...
                          <textarea class="form-control"  name="hospital_info" id="exampleFormControlTextarea1" rows="3"></textarea>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <br>
                                                    <select name="department[]" required class="form-control" id="kt_select2_3" multiple="multiple" >
                                ...
                                @endforeach
                                            ...
                                            <div class="col-xl-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" value="" name="beds" />
                                                </div>
                                                <!--end::Input-->
                                            </div>
                                        </div>
                                    ...
                                    <div class="pb-5" data-wizard-type="step-content">
                                        ...
                                        <div class="my-5">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" value="" name="hospital_locaddress1" placeholder="Address Line 1" value="Address Line 1" />
                                            ...
                                            <div class="form-group">
                                                <label>Image</label>
                                                <input type="file" class="form-control" value="" name="hospital_image" placeholder="image" value="Address Line 2" />
                                            </div>
                                            <!--end::Input-->
                                            <div class="row">
                                                <div class="col-xl-6">
                                                ...
                                                <div class="col-xl-12">
                                                 ...
                                                 <select name="hospital_loccountry" id="category" required class="form-control" value="demo-data">
