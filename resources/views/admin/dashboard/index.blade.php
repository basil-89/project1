	                ...
	                <div class="card card-custom card-stretch gutter-b">
	                    ...
	                    <div class="card-header border-0 py-5">
	                        <h3 class="card-title align-items-start flex-column">
	                            <span class="card-label font-weight-bolder text-dark">New Bookings</span>
	                            <span class="text-muted mt-3 font-weight-bold font-size-sm">More than 400+ new bookings</span>
	                        </h3>
	                    </div>
	                    <!--end::Header-->
	                                ...
	                                <table class="table table-head-custom table-head-bg table-borderless table-vertical-center">
	                                    <thead>
	                                        <tr class="text-left text-uppercase">
	                                            <th style="min-width: 250px;" class="pl-7"><span class="text-dark-75">Username/Client</span></th>
	                                            ...
	                                            <td class="pl-0 py-5">
	                                                <div class="d-flex align-items-center">
	                                                    ...
	                                                    <div>
	                                                        ...
	                                                        <span class="text-muted font-weight-bold d-block">email@gmail.com</span>
	                                                    </div>
	                                                </div>
	                                            </td>
	                                            <td>
