                                      ...
                                      @foreach($country as $data)
                                        <tr>
                                            ...
                                            <td nowrap="">
                                                ...
                                                <a href="#edit" data-toggle="modal" data-id="{{$data->id}}" class="btn btn-sm btn-clean btn-icon edit" data-target="#edit" title="Edit details"> <i class="la la-edit"></i> </a>
                                                <a data-toggle="modal" data-id="{{$data->id}}" data-target="#deleteModal" href="javascript:;" class="btn btn-sm btn-clean btn-icon delete" title="Delete"> <i class="la la-trash"></i> </a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="lable-control">country Title</label>
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    ...
                    <form  action="{{ url('admin/update-country') }}" method="post">
                    @csrf
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="lable-control">Country Title</label>
                            <input type="text" class="form-control input-lg" id="country_name" name="name" required>
                        </div>
                    </div>
                    {{-- <div class="col-md-12">
                        <div class="form-group">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{ url('admin/delete_country') }}" method="post">
                @csrf
...
$('.edit').on('click', function () {
    ...
    var urll= "{{url('country-edit/')}}/"+ edit_id;
