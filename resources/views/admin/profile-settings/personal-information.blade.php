                                        ...
                                        <div class="card-body pt-10">
                                            ...
                                            <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                                                <div class="navi-item mb-2">
                                                    <a href="custom/apps/profile/profile-1/personal-information" class="navi-link py-4 active">
                                ...
                                <div class="flex-row-fluid ml-lg-8">
                                    ...
                                    <div class="card card-custom card-stretch">
                                        ...
                                        <div class="card-header py-3">
                                            ...
                                            <form class="form" method="post" action="{{url('admin/update_admin')}}" enctype="multipart/form-data">
                                             @csrf
                                        ...
                                        <!--begin::Form-->
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-6">
                                                        <input class="form-control form-control-lg form-control-solid" type="text" name="name" value="{{$admin->name}}" />
                                                    </div>
                                                </div>
                                                {{-- <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-6">
                                                        <div class="input-group input-group-lg input-group-solid">
                                                            ...
                                                            <input type="text" class="form-control form-control-lg form-control-solid" value="{{$admin->phone}}" name="phone" placeholder="Phone" />
                                                        </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-6">
                                                        <div class="input-group input-group-lg input-group-solid">
                                                            ...
                                                            <input type="email" name="email" class="form-control form-control-lg form-control-solid" value="{{$admin->email}}" placeholder="Email" />
                                                        </div>
                                                    </div>
                                                </div>
                                                {{-- <div class="form-group row">
