                        ...
                        <div class="card-body pt-10">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="symbol symbol-60 symbol-xxl-100 mr-5 align-self-start align-self-xxl-center">
                                    <div class="symbol-label" style="">
                                        <img src="{{asset('assets/'.$admin->image)}}" class="img-fluid" />
                            ...
                            <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                                <div class="navi-item mb-2">
                                    <a href="custom/apps/profile/profile-1/personal-information" class="navi-link py-4">
                                ...
                                <div class="navi-item mb-2">
                                    <a href="custom/apps/profile/profile-1/change-password.html" class="navi-link active py-4 ">
                                        <span class="navi-icon mr-2">
                                            <span class="svg-icon">
                                ...
                                <div class="flex-row-fluid ml-lg-8">
                                    ...
                                    <div class="card card-custom">
                                        ...
                                        <div class="card-header py-3">
                                            ...
                                            <form class="form" method="post" action="{{url('admin/update_password')}}">
                                                @csrf
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="alert alert-custom alert-light-danger fade show mb-10" role="alert">
                                                    <div class="alert-icon">
                                                        <span class="svg-icon svg-icon-3x svg-icon-danger">
                                                            <!--begin::Svg Icon | path:assets/media/svg/icons/Code/Info-circle.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                    <rect x="0" y="0" width="24" height="24" />
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-6">
                                                        <input type="password" class="form-control form-control-lg form-control-solid mb-2" value="" name="old_password" placeholder="Current password" />
                                                        @error('old_password')
